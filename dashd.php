...
<title>Examen Online Instituto Libertad </title>
...
<nav class="navbar navbar-default title1">
  <div class="container-fluid">
    ...
    <div class="navbar-header">
      ...
      <a class="navbar-brand" href="dashd.php?q=0"><b>Panel de Control</b></a>
    </div>
    <!-- Collect the nav links, forms, and other content for toggling -->
    <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
      <ul class="nav navbar-nav">
        <li <?php if(@$_GET['q']==0) echo'class="active"'; ?>><a href="dashd.php?q=0">Inicio<span class="sr-only">(current)</span></a></li>
        <!--<li <?php if(@$_GET['q']==1) echo'class="active"'; ?>><a href="dashd.php?q=1">Usuarios</a></li>-->
		<li <?php if(@$_GET['q']==2) echo'class="active"'; ?>><a href="dashd.php?q=2">Calificaciones</a></li>
		<li <?php if(@$_GET['q']==3) echo'class="active"'; ?>><a href="dashd.php?q=3">Observaciones</a></li>
        <li class="dropdown <?php if(@$_GET['q']==4 || @$_GET['q']==5) echo'active"'; ?>">
          ...
          <ul class="dropdown-menu">
            <li><a href="dashd.php?q=4">Agregar Examen</a></li>
            <li><a href="dashd.php?q=5">Eliminar Examen</a></li>
...
while($row = mysqli_fetch_array($result)) {
	...
	$id = $row['id'];
	 echo '<tr><td>'.$c++.'</td>';
	echo '<td><a title="Clic para ver la observación" href="dashd.php?q=3&fid='.$id.'">'.$subject.'</a></td><td>'.$email.'</td><td>'.$date.'</td><td>'.$time.'</td><td>'.$name.'</td>
	<td><a title="Abrir observación" href="dashd.php?q=3&fid='.$id.'"><b><span class="glyphicon glyphicon-folder-open" aria-hidden="true"></span></b></a></td>';
