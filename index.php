...
<title>Evaluacion Online  | | 
 Instituto Libertad</title>
...
<div class="col-md-3 box">
<a href="#" data-toggle="modal" data-target="#docente">Acceso Docente</a></div>
<div class="col-md-3 box">
...
<div class="col-md-6">
<form role="form" method="post" action="docente.php?q=index.php">
<div class="form-group">
<input type="text" name="uname" maxlength="21"  placeholder="Usuario Docente" class="form-control"/> 
</div>
<div class="form-group">
<input type="password" name="password" maxlength="15" placeholder="Contraseña Docente" class="form-control"/>
</div>
